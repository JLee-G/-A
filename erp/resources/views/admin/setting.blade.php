...
<head>
    ...
    <link href="{{ asset('admin_1/css/setting.css') }}" rel="stylesheet" media="all">
    <script language='javascript' src='{{ asset('admin_1/js/setting.js') }}'></script>
    <title>權限設定頁面</title>
</head>
<body>
    <div class="frame_1">
        <div class="frame_2">
            ...
            選擇權限：
            <select onchange="ShowRoute(this.value, '{{$Permissions_id_s}}')" >
            ...
            選擇使用者：
            <select onchange="ShowPermissions(this.value, '{{$user_id_s}}')" >
                <option value="">無</option>
